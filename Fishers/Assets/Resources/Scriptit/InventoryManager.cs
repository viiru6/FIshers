...
public class InventoryManager : MonoBehaviour
{
    ...
    public void Add(KalaItem kala)//lis‰‰ kalan inventoryyn jos sit‰ ei sielt‰ viel‰ lˆydy. muuten nostaa stackin kokoa ja refreshaa inventoryn
    {
        fishCaught++;
    ...
    public void Clean()//tyhjent‰‰ n‰kyv‰n inventoryn
    {
